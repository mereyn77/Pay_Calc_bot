...
df=pd.read_excel(filename_nel1, header=None)
df.to_excel(filename_nel1+'.xlsx', index=False, header=False)
wbn1 = openpyxl.load_workbook(filename_nel1+'.xlsx')
sh_nel1 = wbn1.worksheets[0]
os.remove(filename_nel1+'.xlsx')
